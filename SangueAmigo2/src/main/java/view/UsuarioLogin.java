...
public class UsuarioLogin extends javax.swing.JFrame {
         ...
         public void logar(){
            ...
            try{
             Connection c = ConexaoDB.obtemConexao();
              ...
              if (rs.next()) {  
                  UsuarioHome usuarioperfil = new UsuarioHome();
                  
                  new UsuarioHome().setVisible(true);
                  dispose();
                  JOptionPane.showMessageDialog(null, "Seja Bem-Vindo ao Sangue Amigo!");
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/sangueazul.png"))); // NOI18N
